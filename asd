...
local function MainTab()
    ...
    -- Instant Fishing
    local instantSection = Main:Section({Title = "Instant Fishing", Box = true, TextXAlignment = "Center",TextSize = 16})
    local RS = game:GetService("ReplicatedStorage")
    ...
    local function cycle()
        while run do
            pcall(function() REE:FireServer(1) end)
            task.wait(0.2)
    ...
    Main:Space()
    -- Blatant V1
    local blatantSection1 = Main:Section({Title = "Blatant V1",Box = true, TextXAlignment = "Center",TextSize = 16})
    local run1 = false
    ...
    local favoriteSection = Main:Section({Title = "Auto Favorite Feature", Box = true, TextXAlignment = "Center",TextSize = 16})
    Main:Space()
    local RS = game:GetService("ReplicatedStorage")
    local net = RS.Packages._Index["sleitnick_net@0.2.0"].net
...
local function ShopTab()
    ...
    local rodSection = Shop:Section({Title = "Fishing Rod Shop", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local baitSection = Shop:Section({Title = "Purchase Bait", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local weatherSection = Shop:Section({Title = "Purchase Weather", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local merchantSection = Shop:Section({Title = "Traveling Merchant", Box = true, TextXAlignment = "Center", TextSize = 16})
...
local function TeleportTab()
    ...
    local playerSection = Teleport:Section({Title = "Teleport Players", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local islandSection = Teleport:Section({Title = "Teleport Location", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local eventSection = Teleport:Section({Title = "Teleport To Game Event", Box = true, TextXAlignment = "Center", TextSize = 16})
    local P = game:GetService("Players").LocalPlayer
    ...
    local npcSection = Teleport:Section({Title = "Teleport To NPC", Box = true, TextXAlignment = "Center", TextSize = 16})
...
local function AutoTab()
    ...
    local totemSection = Auto:Section({Title = "Totem Features", Box = true, TextXAlignment = "Center", TextSize = 16})
...
local TradeSection = Auto:Section({Title = "Auto Trade", Box = true, TextXAlignment = "Center", TextSize = 16})
...
local Enchantsection = Auto:Section({Title = "Auto Enchant", Box = true, TextXAlignment = "Center", TextSize = 16})
...
local leverxixi = Auto:Section({Title = "Auto Lever", Box = true, TextXAlignment = "Center", TextSize = 16})
...
local =GetRemote(RPath,"RF/CatchFishCompleted")
...
local function QuestTab()
    ...
    -- Deep Sea Quest
    local deepsea = Quest:Section({Title = "Deep Sea Event", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    -- Element Quest Beta
    local element = Quest:Section({Title = "Element Quest Beta", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    -- Diamond Quest
    local diamond = Quest:Section({Title = "Diamond Quest", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local dorian = Quest:Section({Title = "Auto Quest Dorian", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    -- Auto Quest Hank
    local hankSection = Quest:Section({Title = "Auto Quest Hank (Pickaxe)", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local archSection = Quest:Section({Title = "Auto Quest Archaeologist", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local jamesonSection = Quest:Section({Title = "Auto Quest: Scientist Jameson", Box = true, TextXAlignment = "Center", TextSize = 16})
...
local function EventTab()
    ...
    local loknes = Event:Section({Title = "Ancient Lochness Event", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    -- Auto Open Ruin Door
    local ruinDoorSection = Event:Section({Title = "Auto Open Ruin Door", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    local pirateRewardSection = Event:Section({Title = "Pirate Event Rewards", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    -- Pirate Treasure
    local treasureSection = Event:Section({Title = "Pirate Treasure", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    -- Auto Mining
    local miningSection = Event:Section({Title = "Auto Mining", Box = true, TextXAlignment = "Center", TextSize = 16})
...
local function PremiumTab()
    ...
    local KaitunSection = Auto:Section({Title = "Kaitun", Box = true, TextXAlignment = "Center", Opened = false})
...
local function ConfigTabFunction()
    ...
    ConfigTab:Space()
    local PositionSection = ConfigTab:Section({Title = "Auto Save Position", Box = true, TextXAlignment = "Center", TextSize = 16})
    ...
    -- Function to load and teleport to saved position
    local function LoadAndTeleportPosition()
        ...
        -- Teleport 3x in 5 seconds for stability
        WindUI:Notify({
            Title = "Teleporting",
        ...
        task.spawn(function()
            for i = 1, 3 do
                ...
                task.wait(5 / 3) -- 5 seconds / 3 teleports ≈ 1.67 seconds each
            end
            WindUI:Notify({
...
task.spawn(function()
    ...
    -- Wait 3 seconds after position load before loading config
    task.wait(3)
    
    -- Auto Load Config SECOND
